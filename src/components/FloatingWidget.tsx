'use client';
// Loaded via FloatingWidgetClient (dynamic ssr:false) to avoid hydration issues.
...
const SZ      = 64;   // Bubble diameter in pixels, increased for visibility.
  ...
  return (
    <div
      style={{
        ...
        // Animate transform only while snapping or expanding, never while dragging.
    ...
    >
      ...
      <div
        style={{
          ...
          overflow: 'hidden',
          // Keep expand and collapse animated except while dragging.
