    ...
    <section id="facility" className="py-20 px-6 md:px-12 max-w-6xl mx-auto relative z-10 text-center">
      ...
      <div className="mt-16 pt-12 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center md:items-start gap-8 text-left">
        <div className="flex flex-col sm:flex-row gap-12 md:gap-24 w-full md:w-auto">
          <div>
            <h4 className="font-bold text-lg mb-4 text-charcoal">{t('contact')}</h4>
            <div className="space-y-3">
              ...
              <a href="https://wa.me/213000000000" className="flex items-center gap-3 text-gray-600 hover:text-green-600 transition-colors font-medium">
          ...
          <div>
            <h4 className="font-bold text-lg mb-4 text-charcoal">{t('social')}</h4>
            <div className="flex gap-4">
              <a href="https://instagram.com" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-crimson hover:text-white transition-all">
              ...
              <a href="https://linkedin.com" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-blue-600 hover:text-white transition-all">
